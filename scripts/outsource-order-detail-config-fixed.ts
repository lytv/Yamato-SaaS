/**
 * OutsourceOrderDetail Entity Configuration - UPDATED & REVIEWED
 * Following exact patterns from plan implementation
 * All issues fixed based on comprehensive analysis
 */
...
export const outsourceOrderDetailConfig: EntityConfig = {
  ...
  entityNameLower: 'outsourceOrderDetail', // ✅ Fixed: camelCase naming
  entityNamePlural: 'outsourceOrderDetails',
  tableName: 'outsource_order_detail',
  codeField: 'id', // ✅ Fixed: Use id as code field since no natural code
  nameField: 'itemNotes', // ✅ Keep itemNotes as name field
  fields: [
    // ===== RELATIONSHIPS (Fixed displayFields) =====
    {
      name: 'outsourceOrder',
      type: 'relation',
      required: true,
      ...
      relation: {
        ...
        displayField: 'orderCode', // ✅ Verified: exists in outsourceOrderSchema
        onDelete: 'cascade'
      }
    },
    {
      ...
      relation: {
        ...
        entityLower: 'plan',
        foreignKey: 'planId',
        displayField: 'planCode', // ✅ Verified: exists in planSchema
        onDelete: 'restrict'
      }
    },
    {
      ...
      relation: {
        ...
        displayField: 'productCode', // ✅ Verified: exists in productSchema
        onDelete: 'restrict'
      }
    },
    {
      ...
      relation: {
        ...
        displayField: 'stepCode', // ✅ Verified: exists in productionStepSchema
        onDelete: 'restrict'
      }
    },

    // ===== DENORMALIZED FIELDS (Exact match with schema) =====
    {
      name: 'planCode',
      type: 'string',
      required: true,
    ...
    // ===== FINANCIAL FIELDS (Fixed precision) =====
    {
      name: 'unitPrice',
      type: 'decimal',
      required: false,
    ...
    // ===== OWNER FIELD (Fixed: Not a relation) =====
    {
      name: 'ownerId',
      type: 'string',
      required: true,
  ...
  features: {
    ...
    excelImport: true,
    excelExport: true,
    uniqueCode: false, // ✅ Fixed: No natural unique code field

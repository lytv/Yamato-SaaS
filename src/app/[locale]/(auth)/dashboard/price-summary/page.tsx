  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border-t border-gray-200 pt-5">
        <div className="flex flex-col items-start justify-between gap-4 text-sm text-gray-500 sm:flex-row sm:items-center">
          <div className="flex items-center gap-4">
            <span>
              📊 Dữ liệu từ stored procedure:
              {' '}
              <code className="rounded bg-gray-100 px-2 py-1 font-mono text-xs">sp_product_price_pivot</code>
            </span>
          </div>
          <div className="flex items-center gap-4">
            <span>

...
export function ProductionStepDetailList(): JSX.Element {
  ...
  const confirmDeleteSelected = async () => {
    for (const id of selectedIds) {
      try {
        ...
        // Xoá dòng: console.error('❌ Failed to delete item ID:', id, error);
      }
    }
    setSelectedIds([]);
    refresh();
  ...
  const confirmDeleteSingle = async () => {
    ...
    try {
      ...
      // Xoá dòng: console.error('❌ Failed to delete item ID:', deletingDetailId, error);
    } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 bg-gradient-to-r from-slate-50 to-gray-50 p-6 shadow-sm">
        <div className="space-y-6">
          {/* Search Bar */}
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 bg-white py-3 pl-12 pr-4 text-gray-900 shadow-sm transition-all duration-200 placeholder:text-gray-500 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
            />
            {searchInput && (
              <button
                type="button"
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-2">
              <label htmlFor="productFilter" className="flex items-center text-sm font-semibold text-gray-700">
                <svg className="mr-2 size-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm shadow-sm transition-all duration-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
              >
            ...
            <div className="space-y-2">
              <label htmlFor="productionStepFilter" className="flex items-center text-sm font-semibold text-gray-700">
                <svg className="mr-2 size-4 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm shadow-sm transition-all duration-200 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-200"
              >
            ...
            <div className="space-y-2">
              <label htmlFor="sortBy" className="flex items-center text-sm font-semibold text-gray-700">
                <svg className="mr-2 size-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <select
                ...
                className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm shadow-sm transition-all duration-200 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-200"
              >
            ...
            <div className="space-y-2">
              <label className="flex items-center text-sm font-semibold text-gray-700">
                <svg className="mr-2 size-4 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className={`
                    inline-flex flex-1 items-center justify-center rounded-lg px-3 py-2.5 text-sm font-medium shadow-sm transition-all duration-200
                    ${sortOrder === 'desc'
      ...
      : 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50'
                ...
                {(search || productId || productionStepId) && (
                  <button
                    ...
                    className="inline-flex flex-1 items-center justify-center rounded-lg border border-red-300 bg-red-50 px-3 py-2.5 text-sm font-medium text-red-700 shadow-sm transition-all duration-200 hover:bg-red-100"
                  >
                    <svg className="mr-1 size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                    </svg>
              ...
              {search && (
                <span className="inline-flex items-center rounded-full bg-blue-100 px-3 py-1 text-xs font-medium text-blue-800">
                  ...
                  <button
                    ...
                    className="ml-1 inline-flex size-4 items-center justify-center rounded-full hover:bg-blue-200"
                  >
              ...
              {productId && (
                <span className="inline-flex items-center rounded-full bg-green-100 px-3 py-1 text-xs font-medium text-green-800">
                  ...
                  <button
                    ...
                    className="ml-1 inline-flex size-4 items-center justify-center rounded-full hover:bg-green-200"
                  >
                    <svg className="size-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                    </svg>
              ...
              {productionStepId && (
                <span className="inline-flex items-center rounded-full bg-purple-100 px-3 py-1 text-xs font-medium text-purple-800">
                  ...
                  <button
                    ...
                    className="ml-1 inline-flex size-4 items-center justify-center rounded-full hover:bg-purple-200"
                  >
                    <svg className="size-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                    </svg>
            ...
            <div className="flex space-x-2">
              ...
              >
                {isDeleting
                  ? (
                      <>
                        <svg className="-ml-1 mr-2 size-4 animate-spin text-white" fill="none" viewBox="0 0 24 24">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-4 rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-4">
          <div className="flex items-center">
            <input
              type="checkbox"
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                  ...
                  <div className="space-y-4 lg:col-span-4">
                    ...
                    <div className="rounded-lg border border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 p-4">
                      <div className="mb-2 flex items-center">
                        ...
                        <span className="text-xs font-semibold uppercase tracking-wide text-blue-700">{t('table.product')}</span>
                      </div>
                      {product
                        ? (
                            <div>
                              <div className="text-lg font-bold text-blue-900">{product.productCode}</div>
                              <div className="mt-1 text-sm text-blue-700">{product.productName}</div>
                            </div>
                          )
                        : (
                    ...
                    <div className="rounded-lg border border-purple-200 bg-gradient-to-br from-purple-50 to-purple-100 p-4">
                      <div className="mb-2 flex items-center">
                        ...
                        <span className="text-xs font-semibold uppercase tracking-wide text-purple-700">{t('table.productionStep')}</span>
                      </div>
                      {productionStep
                        ? (
                            <div>
                              <div className="text-lg font-bold text-purple-900">{productionStep.stepCode}</div>
                              <div className="mt-1 text-sm text-purple-700">{productionStep.stepName}</div>
                            </div>
                          )
                        : (
                  ...
                  <div className="space-y-4 lg:col-span-3">
                    <div className="text-center">
                      <h4 className="mb-3 flex items-center justify-center text-sm font-semibold text-gray-700">
                        <svg className="mr-2 size-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                      {/* Factory Price */}
                      <div className="rounded-lg border border-green-200 bg-gradient-to-br from-green-50 to-emerald-100 p-3">
                        <div className="text-center">
                          <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-green-700">{t('table.factoryPrice')}</div>
                      ...
                      {/* Calculated Price */}
                      <div className="rounded-lg border border-orange-200 bg-gradient-to-br from-orange-50 to-orange-100 p-3">
                        <div className="text-center">
                          <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-orange-700">{t('table.calculatedPrice')}</div>
                      ...
                      {/* Retail Price */}
                      <div className="rounded-lg border border-purple-200 bg-gradient-to-br from-purple-50 to-purple-100 p-3">
                        <div className="text-center">
                          <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-purple-700">{t('table.retailPrice')}</div>
                  ...
                  <div className="space-y-4 lg:col-span-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="rounded-lg border border-sky-200 bg-gradient-to-br from-sky-50 to-sky-100 p-3 text-center">
                        <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-sky-700">{t('table.quantityLimit1')}</div>
                      ...
                      <div className="rounded-lg border border-cyan-200 bg-gradient-to-br from-cyan-50 to-cyan-100 p-3 text-center">
                        <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-cyan-700">{t('table.quantityLimit2')}</div>
                  ...
                  <div className="space-y-4 lg:col-span-2">
                    {/* Status Badges */}
                    <div className="space-y-2">
                      <div className="mb-2 text-center text-xs font-semibold uppercase tracking-wide text-gray-700">
                        {t('status_flags')}
                      </div>
                ...
                : 'border border-gray-200 bg-gray-100 text-gray-500'
                    ...
                    <div className="flex flex-col space-y-2 pt-2">
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 px-3 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-blue-600 hover:to-indigo-700"
                      >
                        <svg className="mr-2 size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-red-500 to-pink-600 px-3 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-red-600 hover:to-pink-700"
                        disabled={isDeleting}
                      >
                        <svg className="mr-2 size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
            ...
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="rounded-lg p-2 text-white/80 transition-all duration-200 hover:bg-white/20 hover:text-white"
                >

/**
 * PlanDetailSkeleton Component
 * Following TDD Workflow Standards - Green Phase
 * Provides loading skeleton for plandetail list and forms
 */

import React from 'react';

type PlanDetailSkeletonProps = {
  rows?: number;
  className?: string;
...
export function PlanDetailSkeleton({
  ...
  className = '',
  variant = 'desktop',
}: PlanDetailSkeletonProps): JSX.Element {
  ...
  if (variant === 'mobile') {
    return (
      <div
        ...
        role="status"
        aria-label="Loading plandetails"
      >
  ...
  return (
    <div
      data-testid="plandetail-skeleton"
      className={`${className}`}
      role="status"
      aria-label="Loading plandetails"
    >
